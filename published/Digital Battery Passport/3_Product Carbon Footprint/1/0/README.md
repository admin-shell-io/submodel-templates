# Digital Battery Passport – Part 3 Product Carbon Footprint (Version 1.0)

This is a Submodel template specification for the Asset Administration Shell.

## Scope of the Submodel

This Submodel template aims to define the product carbon footprint data points of a Battery Passport conformant to DIN DKE SPEC 99100 and the corresponding EU regulations.
