## Digital Battery Passport - 5_Product Condition bug-fix version 1.0.2
...
- AASX: IDTA 02035-5_DBP-Part-5_ProductCondition.aasx
- PDF: IDTA 02035-5_DBP-Part-5_ProductCondition.pdf (unchanged)
- JSON: IDTA 02035-5_DBP-Part-5_ProductCondition_V1.0.2.json
...
- Constraint violations in this folder: **4**.

### Known remaining issues

These were not corrected here, because the correct value is not determinable from the template alone.

- **AASd-120** (2): Remaining AASd-120 cases sit inside structures where removing the `idShort` would change how the element is addressed; left for review.
- **AASc-3** (1): A ConceptDescription's data specification content does not match its declared type. Resolving this requires the intended IEC 61360 content.
- **The value must not be empty.** (1): An empty required value remains; supplying it would invent template content.
