# Asset Interfaces Description (Version 1.1)
...
3. Data transmission channel between Data Mapping Processor and asset service. Depending on the underlying protocol (e.g., Modbus, MQTT) used by the asset service (and as described by the AID), the specific datapoint can be requested/subscribed.
...
7. HTTP/REST Interface: This is an AAS Interface defined in details of AAS Part 2 as a standardized API [11]. It is used to enable communication between AASX server and external applications.

## About this version

This version is the minor release 1.1 of the Submodel template officially published by IDTA.

## Difference to prior versions

Version 1.0 is available under `../0`. Version 1.1 extends protocol coverage and includes additional mappings and security-related definitions.
