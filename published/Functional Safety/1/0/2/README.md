## Functional Safety bug-fix version 1.0.2
...
- AASX: IDTA 02014-1-0-2_Template_FunctionalSafety.aasx
- JSON: IDTA 02014-1-0-2_Template_FunctionalSafety.json
- AASX: IDTA 02014-1-0-2_Template_FunctionalSafety_forAASMetamodelV3.1.aasx
- JSON: IDTA 02014-1-0-2_Template_FunctionalSafety_forAASMetamodelV3.1.json
...
- **Qualifier kind** ([#159](https://github.com/admin-shell-io/submodel-templates/issues/159)).
  ...
  every JSON and AASX artifact in this folder (31 occurrences per JSON
  artifact).
