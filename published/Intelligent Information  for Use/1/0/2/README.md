## Intelligent Information for Use bug-fix version 1.0.2
...
- AASX: IDTA 02063-1-0-2_Template__IntelligentInformationForUse.aasx
- JSON: IDTA 02063-1-0-2_Template__IntelligentInformationForUse.json
- AASX: IDTA 02063-1-0-2_Template__IntelligentInformationForUse_forAASMetamodelV3.1.aasx
- JSON: IDTA 02063-1-0-2_Template__IntelligentInformationForUse_forAASMetamodelV3.1.json
...
- **Qualifier kind** ([#159](https://github.com/admin-shell-io/submodel-templates/issues/159)).
  ...
  every JSON and AASX artifact in this folder (175 occurrences per JSON
  artifact).
