## Artificial Intelligence Dataset bug-fix version 1.0.2
...
- AASX: IDTA 02058-1-0-2_Template_AIDataset.aasx
- JSON: IDTA 02058-1-0-2_Template_AIDataset.json
- AASX: IDTA 02058-1-0-2_Template_AIDataset_forAASMetamodelV3.1.aasx
- JSON: IDTA 02058-1-0-2_Template_AIDataset_forAASMetamodelV3.1.json
...
- **Qualifier kind** ([#159](https://github.com/admin-shell-io/submodel-templates/issues/159)).
  ...
  every JSON and AASX artifact in this folder (49 occurrences per JSON
  artifact).
