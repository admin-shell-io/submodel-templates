## Energy Flexibility Data Model bug-fix version 1.1
...
- PDF: IDTA 02076_Submodel_EnergyFlexibilityDataModel.pdf (unchanged)
- AASX: IDTA 02076_Template_EnergyFlexibilityDataModel.aasx
- JSON: IDTA 02076_Template_EnergyFlexibilityDataModel.json
