...
An asset type is a representation that defines all the usual properties that are also contained in asset instances at the beginning of their life cycle [Details of the AAS Part 1]. These include, for example, the structure and components used. But also, properties resulting from the engineering are included in the type. For example, the maximum load capacity, allowed environmental conditions. In contrast to this an instance represents a concrete and clearly identifiable entity of a certain type [DotAAS 1]. This instance can contain additional properties like color, serial number, runtime information, etc. in addition to the properties contained in the type. Furthermore, properties in the instance can change over the life cycle and thus deviate from the type.
...
|===
h| idShort: |SimulationModels 
h| Class |Submodel 
h| semanticId: |https://admin-shell.io/idta/SimulationModels/SimulationModels/1/0 
h| Explanation |The Submodel may provide one or more simulation models, a service to generate a specific model, or access to an open or specific query. 
h| [SME type]
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |SimulationModel 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/SimulationModel/1/0 
h| Parent: |SimulationModels 
h| Explanation |Feature collection to provide or request simulation models. Models can be described by objective and content. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |SimPurpose 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/SimPurpose/1/0 
h| Parent: |SimulationModel 
h| Explanation |This characteristic describes the simulation purpose or suitability for different simulation goals. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |Environment 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/Environment/1/0 
h| Parent: |SimulationModel 
h| Explanation |Information about prerequisite environments or dependencies of underlying components on the target system. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |SimulationTool 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/simulationTool/1/0 
h| Parent: |Environment 
h| Explanation |Properties of the model with regarding to concrete simulation tools. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |SolverAndTolerances 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/SolverAndTolerances/1/0 
h| Parent: |SimulationTool 
h| Explanation |Useful settings of the simulation environment. Includes e.g. solver settings. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |TestedToolSolverAlgorithm 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/TestedToolSolverAlgorithm/1/0 
h| Parent: |SolverAndTolerances 
h| Explanation |List of validated tool-solver combinations. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
h| idShort: |ModelFile 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/ModelFile/1/0 
h| Parent: |SimulationModel 
h| Explanation |Providing versions of the simulation model and with characteristics to distinguish them. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |ModelFileVersion 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/ModelFileVersion/1/0 
h| Parent: |ModelFile 
h| Explanation |Provision of a version of the simulation model with information to distinguish the versions. The versions are primarily intended for bug fixes without content changes. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |SimModManufacturerInformation 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/SimModManufacturerInformation/1/0 
h| Parent: |SimulationModel 
h| Explanation |Provide access to simulation support service provided by the distributor via mail or phone. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
h| Class |SubmodelElementCollection 
h| semanticId: |[IRDI] 0173-1#02-AAQ836#005 
h| Parent: |SimModManufacturerInformation 
h| Explanation |E-mail address and encryption method 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/zvei/nameplate/1/0/ContactInformations/ContactInformation/Phone 
h| Parent: |SimModManufacturerInformation 
h| Explanation |Phone number including type 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
h| idShort: |Ports 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/Ports/1/0 
h| Parent: |SimulationModel 
h| Explanation |Interfaces of the model. This includes inputs, outputs as well as acausal connections (e.g. mechanical connections). In addition, it is specified here whether the model provides binary interfaces (e.g. for visualization). 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |PortsConnector 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/PortsConnector/1/0 
h| Parent: |Ports 
h| Explanation |List of ports of the model. These include a name, a description, a list of variables, and a list of ports. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
...
h| idShort: |Variable 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/Variable/1/0 
h| Parent: |PortsConnector 
h| Explanation |- 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
...
[width="100%", cols="1,2,1,1"]
|===
h| idShort: |BinaryConnector 
h| Class |SubmodelElementCollection 
h| semanticId: |[IRI] https://admin-shell.io/idta/SimulationModels/BinaryConnector/1/0 
h| Parent: |Ports 
h| Explanation |Binary interfaces (binaryType) based on the FMI 3.0 standard (https://fmi-standard.org/docs/3.0-dev/#definition-of-types). At this point the name (e.g. "Binary interface visualization") and the description (e.g. "Interface for binary transfer of visualization information") are specified. 
h| [SME type]
h| semanticId = [idType]value
h| [valueType]
h| card.
