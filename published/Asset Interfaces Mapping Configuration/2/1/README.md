## Asset Interfaces Mapping Configuration bug-fix version 2.1

This folder contains a bug-fix release of the submodel template artifacts.
It was produced from version 2 and contains only corrections to the
machine-readable artifacts (JSON and AASX). The specification PDF, where present,
is carried over unchanged.

### Artifacts in this directory

- PDF: IDTA 02027_Submodel Asset Interfaces Mapping Configuration.pdf (unchanged)
- AASX: IDTA 02027_Template_AIMC.aasx
- JSON: IDTA 02027_Template_AIMC.json
- JSON: IDTA 02027_Template_AIMC_without_examplevalues.json
