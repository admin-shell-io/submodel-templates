## Quality Control for Machining bug-fix version 1.1
...
- PDF: IDTA 02049_Submodel_QualityControlForMachining.pdf (unchanged)
- AASX: IDTA_02049_Template_QualityControlForMachining.aasx
- JSON: IDTA_02049_Template_QualityControlForMachining.json
