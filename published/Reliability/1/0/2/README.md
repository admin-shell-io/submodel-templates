## Reliability bug-fix version 1.0.2
...
- AASX: IDTA 02013-1-0-2_Template_Reliability.aasx
- JSON: IDTA 02013-1-0-2_Template_Reliability.json
- AASX: IDTA 02013-1-0-2_Template_Reliability_forAASMetamodelV3.1.aasx
- JSON: IDTA 02013-1-0-2_Template_Reliability_forAASMetamodelV3.1.json
...
- **Qualifier kind** ([#159](https://github.com/admin-shell-io/submodel-templates/issues/159)).
  ...
  every JSON and AASX artifact in this folder (15 occurrences per JSON
  artifact).
